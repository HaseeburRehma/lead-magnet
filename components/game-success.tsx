    ...
    <Card className="bg-zinc-900 border-[#c1ff00]/30 max-w-2xl mx-auto">
      <CardHeader>
        <div className="flex justify-center mb-4">
          <CheckCircle className="h-16 w-16 text-[#c1ff00]" />
        </div>
      ...
      <CardContent className="space-y-4 text-center">
        ...
        <p className="text-[#c1ff00] font-bold">{email}</p>
      ...
      <CardFooter className="flex flex-col space-y-3">
        <Button onClick={onPlayAgain} className="w-full bg-[#c1ff00] hover:bg-[#a8e600] text-black font-bold">
          Play Again
        </Button>
        <a
